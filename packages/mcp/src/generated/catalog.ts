  ...
  },
  {
    ...
    "params": [
      {
        ...
        "desc": "当前账号收藏表情的完整 ID 或 32 位 MD5"
      },
      {
        "name": "group_id",
        "type": "uint",
    ...
    "inputSchema": {
      ...
      "properties": {
        "emoji_id": {
          "type": "string",
          "description": "当前账号收藏表情的完整 ID 或 32 位 MD5"
        },
        "group_id": {
          "type": "integer",
          "minimum": 1,
          "description": "目标群号；与 user_id 二选一",
          "x-role": "group_id"
        },
        "user_id": {
          "type": "integer",
          "minimum": 1,
          "description": "目标 QQ 号；与 group_id 二选一",
          "x-role": "user_id"
        },
        "reply_to": {
          "type": "integer",
